...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.transpose = AttentionTranspose()
    ...
    def forward(self, x):
        ...
        y = self.transpose(y, B, T, C)  # re-assemble all head outputs side by side
        # output projection
...
class HighwayBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        nonlinear = self.attn(self.ln_1(x))
        nonlinear = self.mlp(self.ln_2(nonlinear))
...
class GPT(nn.Module):
    BLOCK_TYPE = {"vanilla": Block, "highway": HighwayBlock}
    ...
    def __init__(self, config):
        ...
        block = self.BLOCK_TYPE[config.block_type]
